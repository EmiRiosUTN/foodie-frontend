...
export function AppModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.52)] p-3 backdrop-blur-[2px] sm:p-6" onClick={onClose}>
      <div
        className={`max-h-[94dvh] w-full overflow-y-auto ${widthClassName} rounded-[28px] border border-white/10 bg-[#1F1F21] p-5 text-white shadow-[0_24px_70px_rgba(0,0,0,0.35)] sm:rounded-[34px] sm:p-7 [&_label]:text-white [&_.foodie-input]:border-0 [&_.foodie-input]:bg-white [&_.foodie-input]:text-[#1F1F21] [&_.foodie-input]:placeholder:text-neutral-500`}
