...
type Profile = { name: string; logoUrl?: string | null; coverImageUrl?: string | null; whatsappPhone?: string | null; accentColor: string; minPartySize: number; maxPartySize: number; supportedFeatures: string[]; branches: Array<{ slug: string; name: string }> };
