...
export type SpecialService = { id?: string; label: string; startTime: string; endTime: string };
...
export function SpecialServicesEditor({ branches, branchId, serviceDate, rows, dirty, loading, onBranchChange, onDateChange, onRowsChange }: Props) {
